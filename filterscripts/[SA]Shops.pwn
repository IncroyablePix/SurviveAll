	...
	switch(shopid)
	{
	    ...
	    case 1://Camp Angel Pine
	    {
	        switch(itemid)
	        {
	            ...
	            case 2: return 250;//Canne � p�che
	            case 3: return 50;//Tron�onneuse
	    ...
	    case 2://Boutique du village des arbres
	    {
	        switch(itemid)
	        {
	            ...
	            case 5: return 15;//B�r�t
	            case 6: return 100;//Cl� anglaise
	    ...
	    case 4://Boutique LV Nord
	    {
	        switch(itemid)
	        {
	            ...
	            case 4: return 8;//Caf�ine
	            case 5: return 10;//Roue
	            case 6: return 35;//Chapeau de sorci�re
	        }
		}
	...
	switch(shopid)
	{
	    ...
	    case 1://Camp Angel Pine
	    {
	        switch(itemid)
	        {
	            ...
	            case 2: return 90;//Canne � p�che
	            case 3: return 7;//Tron�onneuse
	    ...
	    case 2://Boutique du village des arbres
	    {
	        switch(itemid)
	        {
	            ...
	            case 5: return 46;//B�r�t
	            case 6: return 96;//Cl� anglaise
	    ...
	    case 4://Boutique LV Nord
	    {
	        switch(itemid)
	        {
	            ...
	            case 4: return 39;//Caf�ine
	            case 5: return 63;//Roue
	            case 6: return 45;//Chapeau de sorci�re
	        }
		}
		case 5://Boutique Grove Street
		{
...
public NextShopItemForPlayer(playerid, bool:next)
{
	...
	switch(dLanguage)
	{
	    ...
	    case LANGUAGE_PG:
	    {
			if(CallRemoteFunction("HasPlayerGold", "ii", playerid, dPrice)) format(string, sizeof(string), "~g~%s~n~~w~Pre�o: ~y~%.1fg de ouro.~n~~n~~r~~k~~PED_JUMPING~ ~w~para comprar.~n~~r~~<~ - ~>~ ~w~para mudar.~n~~r~~k~~VEHICLE_ENTER_EXIT~ ~w~para sair.", sObjectName, floatdiv(dPrice, 10));
			else format(string, sizeof(string), "~r~%s~n~~w~Pre�o: ~y~%.1fg de ouro.~n~~n~~r~~<~ - ~>~ ~w~para mudar.~n~~r~~k~~VEHICLE_ENTER_EXIT~ ~w~para sair.", sObjectName, floatdiv(dPrice, 10));
	    }
	    case LANGUAGE_IT:
	    {
...
public BuyPlayerItem(playerid)
{
    ...
    if(dFreeSlot  == -1)
    {
		...
		CallRemoteFunction("SendClientMessageEx", "iissssss", playerid, ROUGE, "You cannot carry more items!", "Vous ne pouvez pas porter plus d'objets !", "�No puede llevar m�s objetos!", "Portugais", "Italien", "Sie k�nnen nicht mehr Objekte tragen!");
		return 1;
    }
    new dPrice = GetShopItemPrice(dShop[playerid][0], dShop[playerid][1]);
    ...
    if(CallRemoteFunction("GetPlayerMission", "i", playerid) == MISSION_HAZING_HARVEST && dShop[playerid][0] == 6 && dShop[playerid][1] == 4)
    {
		...
		CallRemoteFunction("ShowPlayerTextInfo", "iissssss", playerid, 5000, "Now hit the ~k~~CONVERSATION_NO~ key to equip the weapon!", "Appuyez sur la touche ~k~~CONVERSATION_NO~ pour �quiper l'arme !", "Espagnol", "Portugais", "Italien", "Allemand");
    }
    return 1;
}
